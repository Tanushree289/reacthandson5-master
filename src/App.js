...
function App() {
  return (
      ...
      <>
        ...
        <p style={{fontSize:"20px"}}>HOC is a function which takes a Wrapped component as input argument and returns a new Enhanced component 
It should always be a pure function. 
It should never modify the Wrapped Component.</p>
        <Movie id={1} />
      
      <div >
        <h1 style={{ textAlign:"center"}}>Pure Component </h1>
        <p style={{fontSize:"20px"}}>ReactJS has provided us a Pure Component. If we extend a class with Pure Component, there is no need for shouldComponentUpdate() Lifecycle Method. ReactJS Pure Component Class compares current state and props with new props and states to decide whether the React component should re-render itself or  Not.
